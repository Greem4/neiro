...
#
#   ./neiro-push/scripts/logs.sh              # хвост в реальном времени
#   ./neiro-push/scripts/logs.sh 500          # последние 500 строк и выход
#   ./neiro-push/scripts/logs.sh --since 1h   # за последний час и выход
#   ./neiro-push/scripts/logs.sh --errors     # только warning/error за сутки
set -euo pipefail
