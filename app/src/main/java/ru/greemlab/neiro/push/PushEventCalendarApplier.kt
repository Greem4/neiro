...
object PushEventCalendarApplier {
    ...
    private fun updateStatus(
        ...
        // Запись без услуги занятием не становится: сервер про услуги ничего
        // не знает, и его событие вернуло бы её в счётчики. Признак ставит
        // только разбор записи при синхронизации.
        if (SessionParser.parse(raw).isNotCounted) return dayData
