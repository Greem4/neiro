 ...
 *
 * Хранится строкой — значение [storageId] уезжает в DataStore, экспорт архива
 * и синхронизацию, поэтому переименовывать его нельзя: старый бэкап должен
 * читаться новой версией приложения. Внутри кода со строками работать не надо,
 * есть [fromStorageId].
 *
