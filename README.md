...
> Самообновление внутри приложения ещё пишется по
> [плану](docs/updater/TASKS.md): проверку новых версий приложение уже делает,
> а скачивание и установку одним нажатием — пока нет. До этого момента новая
> версия ставится файлом со страницы релизов, поверх старой, с сохранением
> данных.
