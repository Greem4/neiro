...
О вышедшей версии приложение узнаёт сразу: сервер `neiro-push` рассылает push
в ту же минуту, когда релиз опубликован. Push не дошёл — приложение и само
спрашивает GitHub раз в сутки и при открытии. Нашло — показывает уведомление;
по согласию скачивает APK, сверяет SHA256 **и** подпись со своей, и ставит
поверх. Настройки, календарь и архив остаются на месте.
...
| Оформление | [docs/appearance.md](docs/appearance.md) | Тема, палитры, семантические цвета и стеклянный вид: что где живёт и почему |
...
| Последний аудит | [docs/archive/audit-14.08.26/](docs/archive/audit-14.08.26/REPORT.md) | Пакет от 14.08.2026: 18 находок, все закрыты; отчёт о прогоне, архитектура на дату |
