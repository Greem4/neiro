...
- **Этапы 1–4** — блокер в разборе ответов YClients (`date` уезжает вместе со
  временем, контракт payload нарушен) плюс две находки в FCM. Три коммита,
...
1. **Правки Этапов 1–4** — [порядок работ](stage1-4-review.md#7-с-чего-начинать),
   3 коммита. Первым — формат даты, он меняет данные в `record_states`.
