...
> **Июль 2026:** проведён повторный полный аудит — см. [`docs/audit-17.07.26/ROADMAP.md`](../audit-17.07.26/ROADMAP.md). Этапы 1–6 этого пакета в коде фактически выполнены (чекбоксы ниже частично устарели); волны A–E новой дорожной карты выполнены 17.07.26 — см. [`docs/audit-17.07.26/REPORT.md`](../audit-17.07.26/REPORT.md).
...
| — | [OUT_OF_SCOPE.md](../audit-17.07.26/OUT_OF_SCOPE.md) | Что НЕ делаем и почему (перенесён к аудиту 17.07.26) | — | — |
