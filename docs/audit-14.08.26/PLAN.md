...
Состояние прогона: **0 из 18 пунктов.**
...
## [ ] 1.1 · S1 · Не стираю месяц по пустому ответу в live-синке
...
## [ ] 1.2 · K2 · Не выкидываю устройство из-за мёртвого токена FCM
...
## [ ] 1.3 · K1 · Считаю лимит входа по настоящему адресу клиента
...
## [ ] 2.1 · K3 · Чищу состояния прошедших записей
...
## [ ] 2.2 · K4 · Поднимаю повторный вход по 401 в поллере
...
## [ ] 2.3 · K5 · Сидирую аккаунты по отдельности
...
## [ ] 2.4 · K6 · Не перепривязываю чужое устройство при входе
...
## [ ] 3.1 · B2 · Гоняю тесты бэкенда в CI
...
## [ ] 3.2 · B1 · Обновил baseline-профиль под текущие сигнатуры
...
★ **Альтернатива, требующая решения:** перейти на генерацию профиля через
`androidx.benchmark` macrobenchmark. Это отдельный модуль и прогон на
устройстве; шапка самого файла на это и указывает («идеально — заменить на
macrobenchmark-генерацию»). Ручная правка разойдётся снова после следующей
переделки главного экрана.

**Коммит:** `Обновил baseline-профиль под текущие сигнатуры`

---

## [ ] 3.3 · B3 · Убрал неиспользуемую проверку ключа
...
## [ ] 4.1 · A1 · Не качаю обновление повторно поверх готового
...
## [ ] 4.2 · A2 · Проверяю разрешение на установку один раз за возврат
...
## [ ] 4.3 · N1 · Чищу ленту уведомлений при выходе из аккаунта
...
## [ ] 4.4 · S2 · Убрал вторую подтяжку календаря на старте
...
## [ ] 4.5 · U1 · Убрал неиспользуемую сводку по всем записям
