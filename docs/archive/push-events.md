...
**Аптайм** в плитке идёт двумя строками: сверху сутки («меньше суток», пока их
нет), снизу часы `ЧЧ:ММ:СС`. Ширина у часов постоянная, поэтому при обновлении
шапки раз в 10 с ничего не дёргается. Раньше он писался словами («12 часов
16 минут»), такая строка не помещалась в плитку, переносилась и поднимала
высоту всего ряда — соседние значения съезжали. В текстовом дашборде
(`dash.sh`) те же части одной строкой: `аптайм 3 дня 04:12:07`.
