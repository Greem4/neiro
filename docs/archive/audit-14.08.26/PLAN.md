...
## [x] 4.6 ★ U2 · Годовой налог: удалить или вывести
...
**Решение пользователя (14.08.26): вариант Б.** Строка «Налог за год» встала под
«Чистыми за год» и показывается только при ненулевом налоге.

Замечание по ходу: с суммой `monthlyNet` годовой налог арифметически не сходится
и сойтись не может — месяц без дохода даёт `net = 0`, а налог за него всё равно
начислен. Свели то, что сводится: источник ставки. Инвариант «год = сумма
налогов месяцев из разбора» закреплён тестом.

---

## [x] 4.7 · D1 · Убрал незавершённый сброс клиентов
