...
> **Июль 2026:** проведён повторный полный аудит — см. [`docs/audit/ROADMAP.md`](../audit/ROADMAP.md). Этапы 1–6 этого пакета в коде фактически выполнены (чекбоксы ниже частично устарели); новые работы ведутся по волнам A–E из новой дорожной карты.
